  ...
  uber: {
    ...
    cities: {
      ...
      kolkata:   { available: true,  type: 'auto', label: 'Uber Auto',  platformFee: 8,   surge: 'Surge pricing applicable',
                   taxi: { available: true, label: 'Uber Go', cabBase: 45, cabPerKm: 9, cabMin: 70, platformFee: 0, surge: 'Dynamic pricing may apply - not tied to the taxi meter' } },
  ...
  ola: {
    ...
    cities: {
      ...
      kolkata:   { available: true,  type: 'auto', label: 'Ola Auto',   platformFee: 8,   surge: 'Dynamic pricing may apply',
                   taxi: { available: true, label: 'Ola Mini', cabBase: 42, cabPerKm: 8, cabMin: 65, platformFee: 0, surge: 'Dynamic pricing may apply - not tied to the taxi meter' } },
  ...
  rapido: {
    ...
    cities: {
      ...
      kolkata:   { available: true,  type: 'auto', label: 'Rapido Auto', platformFee: 5,  surge: 'Dynamic pricing may apply',
                   taxi: { available: true, label: 'Rapido Cab', cabBase: 40, cabPerKm: 7, cabMin: 60, platformFee: 0, surge: 'Dynamic pricing may apply - not tied to the taxi meter' } },
